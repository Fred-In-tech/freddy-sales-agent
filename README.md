...
[![Architecture map](banner.png)](https://fred-in-tech.github.io/architecture-maps/freddy-sales-agent/)

*Interactive, pannable version: [open the architecture map](https://fred-in-tech.github.io/architecture-maps/freddy-sales-agent/)*
