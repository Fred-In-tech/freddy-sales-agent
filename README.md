...
[![Architecture map](banner.png)](https://foglamp.dev/scan/freddy-sales-agent-5exxih)

*Interactive architecture map: [foglamp scan](https://foglamp.dev/scan/freddy-sales-agent-5exxih)*
